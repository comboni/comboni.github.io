...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, CacheFactoryProvider) {
  ...
  .state('app.telemundo', {
    ...
    views: {
      'menuContent': {
        templateUrl: "templates/telemundo.html",
        controller: 'TelemundoCtrl'
      }
    }
  }) 
  .state('app.destak2', {
    ...
    views: {
      'menuContent': {
        templateUrl: "templates/destak2.html",
        controller: 'destak2Ctrl'
      }
    }
  }) 
  .state('app.bookmarks', {
  ...
  .state('app.aguiluchos', {
    url: "/aguiluchos",
    views: {
      'menuContent': {
        templateUrl: "templates/aguiluchos.html",
      }
    }
  })
